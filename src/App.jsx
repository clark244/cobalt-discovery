  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-xs mb-3" style={{ color: "#9CA3AF" }}>Tap a question to see why it matters and an example of how you could measure it.</p>
    ...
    <div className="min-h-screen bg-slate-100 flex justify-center p-3 sm:p-6">
      <div className="w-full max-w-2xl bg-white rounded-2xl shadow-sm overflow-hidden flex flex-col" style={{ height: "88vh" }}>
        ...
        <div ref={scrollRef} className="flex-1 overflow-y-auto px-4 sm:px-5 py-4 space-y-3">
          ...
          {deliverable && <div ref={deliverableRef}><ErrorBoundary onRetry={generate}><Deliverable d={deliverable} onEmailSubmit={saveEmail} /></ErrorBoundary></div>}
